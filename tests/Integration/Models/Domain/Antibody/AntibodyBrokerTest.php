...
namespace Tests\Integration\Models\Domain\Antibody;

use App\Models\Domain\Antibody\AntibodyBroker;
use Tests\IntegrationTestCase;

final class AntibodyBrokerTest extends IntegrationTestCase
{
    private AntibodyBroker $broker;

    protected function setUp(): void
    {
        parent::setUp();
        $this->broker = new AntibodyBroker($this->db);
    }
    ...
    public function testInsertAndFindByImmId(): void
    {
        ...
        $this->assertSame('IMM-2026-0001', $found->immId);
        $this->assertSame('address', $found->type);
        $this->assertSame('malicious', $found->verdict);
        $this->assertSame(85, $found->confidence);
    ...
    {
        $a = $this->broker->insert($this->fixture(immId: 'IMM-2026-0001'));
        $b = $this->broker->insert($this->fixture(immId: 'IMM-2026-0002'));
        $c = $this->broker->insert($this->fixture(immId: 'IMM-2026-0003'));
    ...
    public function testFindRecentSupportsKeysetPagination(): void
    {
        ...
        $this->assertSame($b, $page2[0]->id);
        $this->assertSame($a, $page2[1]->id);
    }
    ...
    /**
     * Build an antibodies-row payload with sensible defaults so individual
