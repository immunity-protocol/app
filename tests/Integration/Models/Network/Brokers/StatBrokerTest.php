...
namespace Tests\Integration\Models\Network\Brokers;

use App\Models\Network\Brokers\StatBroker;
use Tests\IntegrationTestCase;

final class StatBrokerTest extends IntegrationTestCase
{
    private StatBroker $broker;

    protected function setUp(): void
    {
        parent::setUp();
        $this->broker = new StatBroker($this->db);
    }

    public function testLatestByMetricReturnsNewest(): void
    {
        $this->insertSnapshot('antibodies_active', '300', '2026-04-01 00:00:00+00');
        $this->insertSnapshot('antibodies_active', '312', '2026-04-25 00:00:00+00');
        $this->insertSnapshot('antibodies_active', '305', '2026-04-15 00:00:00+00');
    ...
    {
        $this->insertSnapshot('antibodies_active', '312', '2026-04-25 12:00:00+00');
        $this->insertSnapshot('agents_online', '1247', '2026-04-25 12:00:00+00');
    ...
    public function testValueAtOrAfter(): void
    {
        ...
        $this->insertSnapshot('antibodies_active', '305', '2026-04-25 06:00:00+00');
        $this->insertSnapshot('antibodies_active', '312', '2026-04-25 12:00:00+00');
