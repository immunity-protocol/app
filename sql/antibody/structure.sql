...
(
    ...
    escrowed_fees         numeric(20, 6) NOT NULL DEFAULT 0,
    is_seeded             smallint NOT NULL DEFAULT 0,
    prominence_tier       smallint NOT NULL DEFAULT 0,
    corroboration_count   smallint NOT NULL DEFAULT 0,
