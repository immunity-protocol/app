...
final class NetworkConfig
{
    ...
    public static function galileo(): self
    {
        return new self(
            ...
            registryAddress:   getenv('OG_REGISTRY_ADDRESS')  ?: '0x6FfB52ea1a01ABDe2793f6fca2Ea6661ca75903c',
            usdcAddress:       getenv('OG_USDC_ADDRESS')      ?: '0x53d4Df2832A97Ec455D1d0ACe9242baE78f19eC9',
