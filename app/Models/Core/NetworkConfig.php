...
final class NetworkConfig
{
    ...
    public static function baseSepolia(): self
    {
        return new self(
            ...
            deployBlock:               (int) (getenv('BASE_DEPLOY_BLOCK') ?: 42811940),
            registryAddress:           getenv('BASE_REGISTRY_ADDRESS')            ?: '0x7047F4D54A1F4C337BF940cBDee0E68D79B0323b',
            ...
            creVerdictReceiverAddress: getenv('BASE_CRE_RECEIVER_ADDRESS')        ?: '0xC310cC70DD112339550C987D4Df00407B9077aE3',
            novelVerificationAddress:  getenv('BASE_NOVEL_VERIFICATION_ADDRESS')  ?: '0xe151F9f3cBa23DdDcB7e3379e739F17436488376',
